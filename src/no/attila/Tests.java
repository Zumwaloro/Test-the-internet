...
public class Tests {
    ...
    public void closeModalWindow() {
        wait.until(ExpectedConditions.elementToBeClickable(By.className("modal-footer")));
        driver.findElement(By.className("modal-footer")).click();
    }

    public void hoverOverElements() {
        actions.moveToElement(driver.findElement(By.xpath("/html/body/div[2]/div/div/div[1]/img"))).perform();
        actions.moveToElement(driver.findElement(By.xpath("/html/body/div[2]/div/div/div[2]/img"))).perform();
        actions.moveToElement(driver.findElement(By.xpath("/html/body/div[2]/div/div/div[3]/img"))).perform();
    }

    public void dragHorizontalSlider() {
        WebElement slider = driver.findElement(By.className("sliderContainer")).findElement(By.tagName("input"));
